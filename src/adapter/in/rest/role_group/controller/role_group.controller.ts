...
import { queryToFilter } from "../util/role_group.converter";
...
import { RoleGroupService } from "@service/role_group.service";

export class RoleGroupRestController implements BaseController {
  private app: Express;
  private readonly prefix: string = "/role-groups";
  private service: IRoleGroupUseCase;

  constructor(app: Express) {
    this.app = app;
    this.service = new RoleGroupService();
  }
